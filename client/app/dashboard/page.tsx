  ...
  return (
    <div className="container mx-auto px-4 py-6 md:px-8 md:py-10">
      ...
      <div className="mb-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          <h1 className="text-2xl font-medium text-foreground tracking-tight leading-tight md:text-3xl">
        ...
        <button 
            ...
            className="group flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-white transition-all hover:bg-primary/90 active:scale-95 sm:w-auto sm:py-2.5"
        >
      ...
      <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat, index) => (
          <motion.div
            ...
            className="glass-card hover:border-primary/30 rounded-2xl p-6 transition-all border border-border"
          >
