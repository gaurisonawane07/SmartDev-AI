    ...
    return (
        <section id="features" className="mx-auto max-w-7xl px-6 py-20 md:py-32">
            <div className="mb-12 text-center md:mb-16">
                ...
                <p className="mt-4 text-sm text-muted-foreground md:text-base">Everything you need to ship high-quality code, faster.</p>
            </div>
            ...
            >
                ...
                <motion.div
                    ...
                    className="glass-card flex flex-col justify-between overflow-hidden rounded-3xl p-6 md:col-span-2 md:p-8"
                >
                    <div>
                        <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary">
                            <Terminal className="h-6 w-6" />
                        </div>
                        <h3 className="text-xl font-bold text-white md:text-2xl">Context-Aware AI Chat</h3>
                    ...
                    <div className="mt-8 rounded-xl bg-black/40 p-4 border border-white/5 font-mono text-[10px] text-zinc-400 md:mt-10 md:text-xs">
                ...
                >
                    <div>
                        ...
                        <h3 className="text-xl font-bold text-white md:text-2xl">The Code Vault</h3>
                        <p className="mt-2 text-sm text-muted-foreground md:text-base">
                ...
                >
                    <div>
                        ...
                        <h3 className="text-xl font-bold text-white md:text-2xl">Real-time Usage</h3>
                        <p className="mt-2 text-sm text-muted-foreground md:text-base">
                ...
                <motion.div
                    variants={itemVariants}
                    className="glass-card flex flex-col justify-center rounded-3xl p-6 md:col-span-2 md:p-8"
                >
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="flex-1">
                            ...
                            <h3 className="text-xl font-bold text-white md:text-2xl">Deep Conversation History</h3>
                            <p className="mt-2 text-sm text-muted-foreground md:text-base">
                                Never lose a breakthrough. Access your entire development history
                                across multiple chat sessions with powerful search.
                            </p>
                        </div>
                        <div className="grid grid-cols-2 gap-2 w-full max-w-50 md:max-w-xs">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="h-10 md:h-12 rounded-lg bg-white/5 border border-white/5" />
                            ))}
                        </div>
                    </div>
                </motion.div>
